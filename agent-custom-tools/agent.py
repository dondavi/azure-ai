...
def main(): 
    ...
    with (
        ...
        # Track the last response ID for multi-turn chaining
        ...
        while True:
            ...
            if last_response_id is None:
                ...
                # Subsequent turns: chain via previous_response_id
                response = openai_client.responses.create(
            ...
            # Track the last response for multi-turn chaining
